...
namespace Vdp
{
    public class VisaAPIClient
    {
        ...
        public string DoMutualAuthCall(string path,
            string method,
            string testInfo,
        ...
        {
            string requestURL = configuration.VisaUrl + path;// "https://sandbox.api.visa.com/" + path;
            //ConfigurationManager.AppSettings["visaUrl"] + path;
            string userId = configuration.UserId;// "9ZT81TFIPF5J2580SPGF21gh6KriAi_K8UPEkJzQxvLhVgT30";// ConfigurationManager.AppSettings["userId"];
            string password = configuration.Password;// "MCBnAkM1jhpVKCdQ49BHBB9oNyCLQ6F";// ConfigurationManager.AppSettings["password"];
            string certificatePath = configuration.CertificatePath;// @"C:\Visa\p12certfile.p12";// ConfigurationManager.AppSettings["cert"];
            string certificatePassword = configuration.CertificatePassword;// "";// ConfigurationManager.AppSettings["certPassword"];
            string statusCode = "";
